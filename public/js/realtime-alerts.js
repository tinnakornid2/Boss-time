(function () {
    ...
    const SYSTEM_TEXT = [
        ...
        ['Copied delay from', 'คัดลอกเวลาหน่วงจาก'],
        ['Select a boss name below; Paste appears only on that row.', 'เลือกชื่อบอสปลายทางด้านล่าง แล้วปุ่มวางจะปรากฏเฉพาะแถวนั้น'],
        ['Select as paste destination', 'เลือกเป็นบอสปลายทาง'],
        ['Paste copied delay here', 'วางเวลาหน่วงที่บอสตัวนี้'],
